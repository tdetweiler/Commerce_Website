<!--
	...
	Date: April 19, 2013
	This page is to create the checkout page for south sound circles.
-->
	...
	<?php 
		...
		echo "<center><table border = '1' align='right' style = 'width:100%'; 'alignment:center';><tr>";
		 ...
		 for($j = 0; $j < count($_SESSION['cart']); $j++){
	    	...
	    	{
	 		  echo "<tr>";
			  for ($i = 0; $i < mysql_num_fields($records2)+2; $i++)
			   {
			    	...
			    	{
						$totalCost = $totalCost + $temp[1]*$theRecord[2];
			    		echo "<td>". "$" .
			    		($temp[1]*$theRecord[2])
			    		. " </td>\n";		
		 ...
		 echo "<right><table border = '1' align='right' style = 'width:25%'; 'alignment:right';><tr>";
		 echo "<tr>";
		 echo "<td>Total Cart Cost: </td>";
		 ...
		 echo  "&nbsp";
		 echo "</br>";
		 echo "<a href = 'processOrder.php'><input type='button' value='Finalize Order' style = 'float:right; height:25px;''></a>";
